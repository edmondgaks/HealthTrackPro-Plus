...
app.post('/api/sensor-data', (req, res) => {
    const { heartRate, bodyTemperature } = req.body; // Assuming request body contains heartRate and bodyTemperature
  
    // Store data in the database or any other processing you need to do
    // For now, let's just send a response with the received data
    console.log(heartRate);
    console.log(bodyTemperature);
    res.json({ heartRate, bodyTemperature });
  });
